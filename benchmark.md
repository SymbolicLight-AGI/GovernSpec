...
Use this file to document repeatable IntentSpec v0.1 benchmark runs.
...
- Does IntentSpec improve strict JSON contract compliance over a plain prompt baseline?
...
| --- | --- | --- | --- | --- |
| T-001 | markdown | `benchmark/tasks/customer_brief.intent.yaml` | `benchmark/outputs/customer_brief.output.md` | |
| T-002 | json | `benchmark/tasks/report_json.intent.yaml` | `benchmark/outputs/report_json.output.json` | |
| T-003 | imports | `benchmark/tasks/imported_customer_brief.intent.yaml` | `benchmark/outputs/imported_customer_brief.output.md` | |
...
| --- | --- | --- |
| Test pass rate | Share of runs that pass `intent test` | CLI |
| JSON schema pass rate | Share of JSON outputs that satisfy `output.schema` | `json_schema` |
| Import consistency | Shared constraints preserved after `imports` | `intent inspect` + tests |
...
intent inspect benchmark/tasks/imported_customer_brief.intent.yaml --format json
intent compile benchmark/tasks/report_json.intent.yaml --target openai-structured
intent compile benchmark/tasks/report_json.intent.yaml --target mcp-plan
```
