# Annotation protocol for the reproducibility benchmark
...
The current release uses two AI-assisted annotation passes:

- `ai_pass_a`: first-pass label assignment from the sample and contract.
- `ai_pass_b`: second-pass consistency label assignment from the same materials.
...
reporting. Disagreements between the two AI-assisted passes are resolved by
