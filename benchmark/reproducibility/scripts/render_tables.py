"""Render publication-ready summaries from reproducibility benchmark result JSON."""
...
from benchmark_helpers import RESULTS_DIR, markdown_table, read_json, write_json, write_text
