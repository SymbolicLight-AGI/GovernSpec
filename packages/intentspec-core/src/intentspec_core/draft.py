"""Enhanced heuristic draft generator for ``intent draft``.

Turns a free-text prompt (Chinese or English) into a best-effort
IntentSpec YAML payload — without calling any LLM.
"""
...
from intentspec_core.common.utils import dedupe_preserve_order
...
def heuristic_draft_payload(prompt: str) -> dict[str, Any]:
    """Generate a draft IntentSpec payload from a free-text prompt."""
