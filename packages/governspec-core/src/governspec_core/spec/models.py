"""Pydantic models for GovernSpec v0.1."""
...
class GovernSpec(BaseDocument):
    kind: Literal["GovernSpec"]
    metadata: Metadata
    task: Task
...
class GovernPack(BaseDocument):
    kind: Literal["GovernPack"]
    metadata: Metadata
...
GovernDocument = GovernSpec | GovernPack
GovernDocumentAdapter: TypeAdapter[GovernDocument] = TypeAdapter(GovernDocument)
