"""Acceptance testing for GovernSpec outputs."""
...
from governspec_core.common.utils import (
    estimate_word_count,
    find_json_path,
    format_count,
)
from governspec_core.spec.models import Assertion, GovernSpec, JsonOutput
...
def test_output(spec: GovernSpec, output_text: str) -> TestReport:
    passed: list[str] = []
    failed: list[str] = []
    warnings: list[str] = []
